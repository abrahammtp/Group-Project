    ...
    $("#add-exercise").on("click", function (event) {
        ...
        $.ajax({
            ...
            for (let i = 0; i < results.length; i++) {
                ...
                // var videoDiv = $('<iframe>');
                var dataVideo = $("<div class='carousel-item active'><div class='embed-responsive embed-responsive-4by3'><iframe width='560' height='315' class='embed-responsive-item' src='https://www.youtube.com/embed/" + results[i].id.videoId + "' frameborder='0' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe></div></div>");
